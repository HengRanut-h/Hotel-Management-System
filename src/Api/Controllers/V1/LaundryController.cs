...
public sealed class LaundryController(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<IEnumerable<OperationalResponse>>.Ok(
                response.Items,
                "Laundry requests retrieved successfully.",
                meta: new
                {
                    pagination = new
                    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Ok(
                response,
                "Laundry request retrieved successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return CreatedAtAction(
            ...
            ApiResponse<OperationalResponse>.Created(
                response,
                "Laundry request created successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Updated(
                response,
                "Laundry request updated successfully.",
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<object?>.Action(
                null,
                "Laundry request status updated successfully.",
                "STATUS_CHANGED",
                HttpContext.TraceIdentifier));
    }
