...
[ApiController]
[Route("api/v1/room-changes")]
public sealed class RoomChangesController(
    RoomChangesService service)
    : ControllerBase
{
    // =========================================================
    // GET ALL
    ...
    [HasPermission("room-changes.view")]
    [HttpGet]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<IEnumerable<OperationalResponse>>.Ok(
                response.Items,
                "Room changes retrieved successfully.",
                meta: new
                {
                    pagination = new
                    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Ok(
                response,
                "Room change retrieved successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("room-changes.create")]
    [HttpPost]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return CreatedAtAction(
            ...
            ApiResponse<OperationalResponse>.Created(
                response,
                "Room change created successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("room-changes.update")]
    [HttpPut("{id:guid}")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Updated(
                response,
                "Room change updated successfully.",
    ...
    [HasPermission("room-changes.manage")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<object?>.Action(
                null,
                "Room change status updated successfully.",
                "STATUS_CHANGED",
                HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("room-changes.delete")]
    [HttpDelete("{id:guid}")]
