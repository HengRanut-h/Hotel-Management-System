...
public sealed class SecurityIncidentsController(
    SecurityIncidentsService service)
    : ControllerBase
{
    // =========================================================
    // GET ALL
    ...
    [HasPermission("security-incidents.view")]
    [HttpGet]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Ok(
                response,
                "Security incident retrieved successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("security-incidents.create")]
    [HttpPost]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return CreatedAtAction(
            ...
            ApiResponse<OperationalResponse>.Created(
                response,
                "Security incident created successfully.",
                traceId: HttpContext.TraceIdentifier));
    }

    // =========================================================
    // UPDATE
    // PUT /api/v1/security-incidents/{id}
    // =========================================================

    [HasPermission("security-incidents.update")]
    [HttpPut("{id:guid}")]
    ...
    [HasPermission("security-incidents.manage")]
    ...
    [HasPermission("security-incidents.delete")]
    [HttpDelete("{id:guid}")]
