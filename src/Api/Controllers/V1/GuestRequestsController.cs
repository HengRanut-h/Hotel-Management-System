...
[ApiController]
[Route("api/v1/guest-requests")]
public sealed class GuestRequestsController(
    GuestRequestsService service)
    : ControllerBase
{
    // =========================================================
    // GET ALL
    ...
    [HasPermission("guest-requests.view")]
    [HttpGet]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<IEnumerable<OperationalResponse>>.Ok(
                response.Items,
                "Guest requests retrieved successfully.",
                meta: new
                {
                    pagination = new
                    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Ok(
                response,
                "Guest request retrieved successfully.",
                traceId: HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("guest-requests.create")]
    [HttpPost]
    ...
    [HasPermission("guest-requests.update")]
    [HttpPut("{id:guid}")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<OperationalResponse>.Updated(
                response,
                "Guest request updated successfully.",
    ...
    [HasPermission("guest-requests.manage")]
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Ok(
            ApiResponse<object?>.Action(
                null,
                "Guest request status updated successfully.",
                "STATUS_CHANGED",
                HttpContext.TraceIdentifier));
    }
    ...
    [HasPermission("guest-requests.delete")]
    [HttpDelete("{id:guid}")]
