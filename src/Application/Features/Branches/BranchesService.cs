...
namespace HotelManagement.Application.Features.Branches;

public sealed class BranchesService(
    CatalogCrudService<HotelBranch> crud)
{
    // =========================================================
    // GET ALL
    // =========================================================
    ...
    public Task<CatalogResponse> GetAsync(
        Guid id,
        CancellationToken cancellationToken) =>
        crud.GetByIdAsync(
            id,
