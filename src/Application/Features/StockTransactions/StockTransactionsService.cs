...
namespace HotelManagement.Application.Features.StockTransactions;

public sealed class StockTransactionsService(
    OperationalCrudService<StockTransaction> crud)
{
    // =========================================================
    // GET ALL
    // =========================================================
