...
namespace HotelManagement.Application.Features.Attendance;

public sealed class AttendanceService(
    OperationalCrudService<AttendanceRecord> crud)
{
    // =========================================================
    // GET ALL
    // =========================================================
    ...
    public Task<OperationalResponse> ChangeStatusAsync(
        Guid id,
