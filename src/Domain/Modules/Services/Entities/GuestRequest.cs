...
public sealed class GuestRequest : AuditableEntity, IOperationalRecord
{
    private GuestRequest() { }
    public GuestRequest(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
