...
public sealed class Complaint : AuditableEntity, IOperationalRecord
{
    private Complaint() { }
    public Complaint(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
