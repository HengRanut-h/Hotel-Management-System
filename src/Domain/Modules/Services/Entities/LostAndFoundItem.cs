...
namespace HotelManagement.Domain.Modules.Services.Entities;

public sealed class LostAndFoundItem : AuditableEntity, IOperationalRecord
{
    private LostAndFoundItem() { }
    public LostAndFoundItem(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
