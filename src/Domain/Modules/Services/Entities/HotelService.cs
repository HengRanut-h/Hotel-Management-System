...
public sealed class HotelService : AuditableEntity, ICatalogEntity
{
    private HotelService() { }
    public HotelService(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
