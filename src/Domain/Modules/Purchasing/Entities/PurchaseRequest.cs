...
namespace HotelManagement.Domain.Modules.Purchasing.Entities;

public sealed class PurchaseRequest : AuditableEntity, IOperationalRecord
{
    private PurchaseRequest() { }
    public PurchaseRequest(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
