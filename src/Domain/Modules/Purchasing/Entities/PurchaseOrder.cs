...
public sealed class PurchaseOrder : AuditableEntity, IOperationalRecord
{
    private PurchaseOrder() { }
    public PurchaseOrder(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
