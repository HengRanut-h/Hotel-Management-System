...
public sealed class GoodsReceipt : AuditableEntity, IOperationalRecord
{
    private GoodsReceipt() { }
    public GoodsReceipt(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
