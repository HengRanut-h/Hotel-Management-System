...
public sealed class UtilityRate : AuditableEntity, ICatalogEntity
{
    private UtilityRate() { }
    public UtilityRate(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
