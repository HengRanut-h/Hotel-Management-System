...
public sealed class Refund : AuditableEntity, IOperationalRecord
{
    private Refund() { }
    public Refund(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
