...
public sealed class Deposit : AuditableEntity, IOperationalRecord
{
    private Deposit() { }
    public Deposit(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
