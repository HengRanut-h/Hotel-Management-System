...
public sealed class StockTransaction : AuditableEntity, IOperationalRecord
{
    private StockTransaction() { }
    public StockTransaction(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
