...
public sealed class Warehouse : AuditableEntity, ICatalogEntity
{
    private Warehouse() { }
    public Warehouse(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
