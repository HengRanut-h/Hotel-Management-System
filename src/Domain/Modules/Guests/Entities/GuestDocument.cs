...
public sealed class GuestDocument : AuditableEntity, IOperationalRecord
{
    private GuestDocument() { }
    public GuestDocument(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
