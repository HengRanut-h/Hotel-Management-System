...
namespace HotelManagement.Domain.Modules.Transportation.Entities;

public sealed class TransportRequest : AuditableEntity, IOperationalRecord
{
    private TransportRequest() { }
    public TransportRequest(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
