...
public sealed class FeatureFlag : AuditableEntity, ICatalogEntity
{
    private FeatureFlag() { }
    public FeatureFlag(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
