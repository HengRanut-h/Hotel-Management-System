...
public sealed class StayExtension : AuditableEntity, IOperationalRecord
{
    private StayExtension() { }
    public StayExtension(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
