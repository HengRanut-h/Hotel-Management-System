...
public sealed class RoomAssignment : AuditableEntity, IOperationalRecord
{
    private RoomAssignment() { }
    public RoomAssignment(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
