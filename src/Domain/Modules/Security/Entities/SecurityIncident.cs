...
namespace HotelManagement.Domain.Modules.Security.Entities;

public sealed class SecurityIncident : AuditableEntity, IOperationalRecord
{
    private SecurityIncident() { }
    public SecurityIncident(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
