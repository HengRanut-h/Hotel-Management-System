...
public sealed class AttendanceRecord : AuditableEntity, IOperationalRecord
{
    private AttendanceRecord() { }
    public AttendanceRecord(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
