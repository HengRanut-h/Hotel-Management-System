...
public sealed class Department : AuditableEntity, ICatalogEntity
{
    private Department() { }
    public Department(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
