...
public sealed class LeaveRequest : AuditableEntity, IOperationalRecord
{
    private LeaveRequest() { }
    public LeaveRequest(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
