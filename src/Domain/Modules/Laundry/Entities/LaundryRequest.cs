...
namespace HotelManagement.Domain.Modules.Laundry.Entities;

public sealed class LaundryRequest : AuditableEntity, IOperationalRecord
{
    private LaundryRequest() { }
    public LaundryRequest(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
