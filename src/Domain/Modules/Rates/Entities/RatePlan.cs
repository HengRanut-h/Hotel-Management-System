...
namespace HotelManagement.Domain.Modules.Rates.Entities;

public sealed class RatePlan : AuditableEntity, ICatalogEntity
{
    private RatePlan() { }
    public RatePlan(Guid hotelId, Guid? branchId, string name, string code, string? description = null)
    {
        HotelId = hotelId;
        BranchId = branchId;
        Name = name.Trim();
