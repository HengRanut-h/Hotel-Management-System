...
public sealed class RoomInspection : AuditableEntity, IOperationalRecord
{
    private RoomInspection() { }
    public RoomInspection(Guid hotelId, Guid? branchId, string referenceNumber, string title, string status,
